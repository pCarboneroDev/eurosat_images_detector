...
- **Real-time classification** of satellite images
- **10 categories**: crops, forests, industrial areas, water bodies, etc.
- **Modern web interface** with React + shadcn/ui
- **REST API** with FastAPI
- **ResNet18 model** with fine-tuning (93% accuracy)
